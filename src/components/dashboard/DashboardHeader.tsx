    ...
    <View className="flex-row items-center justify-between px-6 py-4">
      <View className="flex-row items-center gap-x-3">
        ...
        <View>
          ...
          <Text className="text-xl font-semibold text-black">{USER_DATA.name}</Text>
        </View>
      </View>
      ...
      <View className="flex-row items-center gap-x-4">
        <Pressable className="relative p-1">
          ...
          {/* Notification Dot */}
          <View className="absolute top-1 right-1 w-2.5 h-2.5 bg-danger rounded-full border-2 border-[#F9FAFB]" />
        </Pressable>
